...
from spec.ir.container import NarrativeIR, Provenance, Project
...
def _ir_with_provenance() -> NarrativeIR:
    ...
    prov = Provenance(
        ...
        brand_ver="1", ruleset_ver="1", promptset_ver="1", model_id="m",
        temperature=0.7, seed=1, input_hash="h", created_at=datetime.now(UTC),
    )
